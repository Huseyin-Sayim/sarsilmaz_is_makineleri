                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-lg-9">
                            <div class="input-group">
                                ...
                                <input type="text" name="service_title" class="form-control" placeholder="Başlık Giriniz" required>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-lg-9">
                            <div class="input-group">
                                ...
                                <textarea class="form-control" name="service_intro_text" placeholder="Hizmet Hakkında Ön Bilgi Giriniz" required></textarea>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-lg-9">
                            <div class="input-group">
                                ...
                                <input type="text" class="d-none" id="service_image_input" name="service_image" value="">
