                    ...
                    <form action="{{ route("slider.update", [$slider->id]) }}" method="post">
                        ...
                        <span class="input-group-text text-primary">
                            <i class="ph ph-text-h-one"></i>
                                    ...
                                    <input type="text" name="slider_title" class="form-control" value="{{ $slider->slider_title }}" placeholder="Başlık Giriniz" required>
                                </div>
                            </div>
                        </div>
                        ...
                        <span class="input-group-text text-primary">
                            <i class="ph ph-brackets-curly"></i>
                                    ...
                                    <input type="text" name="slider_button" class="form-control" value="{{$slider->slider_button}}" placeholder="Giriniz" required>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-lg-9 ">
                                <div class="input-group ">
                                    <textarea class="form-control" id="ckeditor_classic_prefilled" name="slider_description" placeholder="Metin Giriniz" required>{{ $slider->slider_description }}</textarea>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <span class="input-group-text bg-input text-primary">
                                <i class="ph ph-image"></i>
                                    ...
                                    <input type="text" class="d-none" id="slider_image_input" name="slider_image" value="{{ $slider->slider_image }}" >
